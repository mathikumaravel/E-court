class JudgesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @judge.save
        format.html { redirect_to judge_url(@judge), notice: "Judge was successfully created." }
  ...
  def update
    respond_to do |format|
      if @judge.update(judge_params)
        format.html { redirect_to judge_url(@judge), notice: "Judge was successfully updated." }
  ...
  private
    ...
    def judge_params
      params.require(:judge).permit(:judge_name)
    end
end
