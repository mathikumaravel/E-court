class CaseInfosController < ApplicationController
  ...
  private
    ...
    def case_info_params
      params.require(:case_info).permit(:case_category, :court_name, :judge_name, :registration_number, :case_stage, :petitioner_name, :petitioner_advocate, :respondent_name, :respondent_advocate, :business_on_date, :hearing_date, :purpose_of_hearing)
    end
end
